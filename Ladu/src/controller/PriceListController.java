...
public class PriceListController extends BaseController {
        ...
        /**
         * meetod, mis otsustab, kas soovitakse teha tegevusi pricelists v�i pricelist-iga seoses
         * @param request
         * @param dao
         * @return view
         */
        ...
        /**
         * meetid, mis m22rab hinnakirja muutmise lehe andmed p��rdudes DAO poole
         * @param request
         * @param dao
         */
