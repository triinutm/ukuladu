 ...
 * @see .CustomerPriceList
 * @author Hibernate Tools
 */
public class CustomerPriceListHome {

	private static final Logger log = Logger.getLogger(CustomerPriceListHome.class);
	...
	public CustomerPriceList findById(long id) {
		...
		try {
			CustomerPriceList instance = (CustomerPriceList) sessionFactory
					.getCurrentSession().get("CustomerPriceList", id);
			if (instance == null) {
	...
	public List findByExample(CustomerPriceList instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("CustomerPriceList")
