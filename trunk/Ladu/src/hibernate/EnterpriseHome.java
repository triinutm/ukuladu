...
/**
 * Home object for domain model class Enterprise.
 * @see hibernate.Enterprise
 * @author Hibernate Tools
 */
public class EnterpriseHome {

	private static final Log log = LogFactory.getLog(EnterpriseHome.class);
	...
	public void persist(Enterprise transientInstance) {
		log.debug("persisting Enterprise instance");
		try {
	...
	public Enterprise merge(Enterprise detachedInstance) {
		...
		try {
			Enterprise result = (Enterprise) sessionFactory.getCurrentSession()
	...
	public Enterprise findById(long id) {
		...
		try {
			Enterprise instance = (Enterprise) sessionFactory
					.getCurrentSession().get("hibernate.Enterprise", id);
			if (instance == null) {
	...
	public List findByExample(Enterprise instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("hibernate.Enterprise")
